...
class BasicAttention(nn.Module):
    ...
    def forward(self, q_embd, k_embd, v_embd, axis=-1,mask=None,return_score=False):
        '''
        ...
        '''
        # print(self.q_embd_size,self.q_k_hidden_size,)
        ...
        score = nn.functional.softmax(score, dim=0)
        ...
        if return_score:
            return output,original_score,pre_sm_score
